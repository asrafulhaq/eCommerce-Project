                        ...
                        @foreach ($all_posts as $post)
                            ...
                            <article class="post-single">
                                <div class="post-info">
                                    ...
                                    <h6 class="upper"><span>By</span><a href=""> {{ $post->user->name }}</a><span
                                            class="dot"></span><span>{{ date('d F, Y', strtotime($post->created_at)) }}</span><span
                                            class="dot"></span>
                                            ...
                                            <ul class="slides">
                                                ...
                                                @foreach ($featured->post_gallery as $gall)
                                                    <li class="flex-active-slide"
                                                        ...
                                                        <img src="{{ URL::to('') }}/media/posts/{{ $gall }}"
                                                            alt="" draggable="true">
                                                    </li>
                                                @endforeach
                                            </ul>
                                ...
                                <div class="post-body">
                                    ...
                                    <p>
                                        <a href="{{ route('post.single', $post->slug) }}"
                                            class="btn btn-color btn-sm">Read More</a>
                                    </p>
                                </div>
                            </article>
                            <!-- end of article-->
