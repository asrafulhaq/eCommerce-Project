                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="badge badge-primary" href="{{ route('post.index') }}">Published
                                    {{ $published == 0 ? '' : $published }}</a>
                                <a class="badge badge-danger" href="{{ route('post.trash') }}">Trash
                                    {{ $trash == 0 ? '' : $trash }}</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="status-toggle">
                                                            <input type="checkbox" status_id="{{ $data->id }}"
                                                                {{ $data->status == true ? 'checked="checked"' : '' }}
                                                                id="cat_status_{{ $loop->index + 1 }}"
                                                                class="check cat_check">
                                                            <label for="cat_status_{{ $loop->index + 1 }}"
                                                                class="checktoggle">checkbox</label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        {{-- <a class="btn btn-sm btn-info" href="#"><i class="fa fa-eye" aria-hidden="true"></i></a> --}}
                                                        <a edit_id="{{ $data->id }}" class="btn btn-sm btn-warning"
